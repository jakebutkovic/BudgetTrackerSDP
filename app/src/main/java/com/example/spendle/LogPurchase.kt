...
class LogPurchase : ComponentActivity() {
    fun logPurchase(m: String, d: String, y: String, name: String, price: String, category: String, transaction: String) {
        ...
        Toast.makeText(this, "Purchase Logged!", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        confirmButton.setOnClickListener {
            ...
            var price: String
            if (priceText.text.toString() == "") price = "0.0"
            else price = priceText.text.toString()
